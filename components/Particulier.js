            ...
            <div className={styles.section6}>
              <div className={styles.content_section6}>
                <div className={styles.paragraphe_section6}>
                  ...
                  notre entreprise adaptée, nous tenons à valoriser l'insertion
                  de nos collaborateurs en situation de l'handicap,{" "}
          ...
          <div>
            <div className={styles.section7}>
              <div className={styles.content_section7}>
                En optant pour une expérience à taille humaine alliant passion
